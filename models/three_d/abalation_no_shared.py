...
class ProjectionSegNet(nn.Module):
    ...
    def __init__(self, in_channels=1, out_channels=1, init_features=32, tsne_mode=False) -> None:
        super().__init__()
        ...
        self.encoder_3d = StdcEncoder(in_channels, init_features, seperate=True)
    ...
    def forward(self, inputs):
        # * 3d 2d Path
        xy_planes, xz_planes, yz_planes, masks, _, stack_list = self.encoder(inputs)
        out_3d_list = self.encoder_3d(inputs)
